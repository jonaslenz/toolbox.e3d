...
It can be fitted to the cumulative runoff from the plot or to an infiltration rate at a certain time step.
...
It can be fitted to the cumulative soil loss from the plot or to a sediment concentration at a certain time step.
