...
#' @examples
#'
determine.skin.infil.E3D <- function(Cl, Si, Sa, Corg, Bulk, Moist, endinfil, endmin, simlines = 100, path = "C:/E3Dmodel/", silent=TRUE)
{
  if(endinfil<=0){print("endinfiltration is <= 0; not possible to simulate in E3D"); return(NA);}
